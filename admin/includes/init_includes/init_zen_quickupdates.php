...
$module_constant = 'ZEN_QUICKUPDATES_VERSION';
$module_installer_directory =  DIR_FS_ADMIN.'includes/installers/zen_quickupdates';
$module_name = "Zen Quickupdates"; 


//Just change the stuff above... Nothing down here should need to change
if(defined('ZEN_QUICKUPDATES_VERSION')) 
{ 
  $current_version = ZEN_QUICKUPDATES_VERSION; 
} 
else { 
